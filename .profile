...
export FILE="lf"
export BIB="$HOME/workspace/bib/uni.bib"
export REFER="$HOME/workspace/bib/referbib"
...
export _JAVA_OPTIONS="-Dawt.useSystemAAFontSettings=lcd_hrgb -Dswing.aatext=true -Djava.util.prefs.userRoot=$XDG_CONFIG_HOME/java -Duser.home=$XDG_DATA_HOME/java"
